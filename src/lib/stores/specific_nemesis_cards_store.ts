...
export const wayward_one_t1_nemesis_cards = readable(wayward_one_tier_1_cards);
export const wayward_one_t2_nemesis_cards = readable(wayward_one_tier_2_cards);
export const wayward_one_t3_nemesis_cards = readable(wayward_one_tier_3_cards);